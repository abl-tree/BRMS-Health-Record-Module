          ...
          <table class="table table-responsive-sm table-hover table-outline mb-0">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center">
                  <div class="avatar">
                    <img src="{{ asset('/assets/img/avatars/2.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
              ...
              <tr>
                <td class="text-center">
                  <div class="avatar">
                    <img src="{{ asset('/assets/img/avatars/3.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
              ...
              <tr>
                <td class="text-center">
                  <div class="avatar">
                    <img src="{{ asset('/assets/img/avatars/4.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
              ...
              <tr>
                <td class="text-center">
                  <div class="avatar">
                    <img src="{{ asset('/assets/img/avatars/6.jpg') }}" class="img-avatar" alt="admin@bootstrapmaster.com">
                    <span class="avatar-status badge-danger"></span>
                  </div>
                </td>
                <td>
